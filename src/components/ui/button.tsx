  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-white/40 bg-[#1a1a1a] text-white ' +
          'hover:bg-[#222222] hover:border-white/60 hover:shadow-[0_0_22px_rgba(255,255,255,0.14)] ' +
          'active:bg-[#1a1a1a] active:border-white/45',
        ghost:
          'text-[#888] ' +
