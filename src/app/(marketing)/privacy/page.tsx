        ...
        <div className="prose prose-invert prose-sm max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-[#9CA3AF] text-sm leading-relaxed">
              ...
              Contact: <a href="mailto:privacy@taskpilot.dev" className="text-white">privacy@taskpilot.dev</a>
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-[#9CA3AF] leading-relaxed">
              ...
              <a href="mailto:privacy@taskpilot.dev" className="text-white">privacy@taskpilot.dev</a>
            </p>
          </section>
        </div>
      </main>
