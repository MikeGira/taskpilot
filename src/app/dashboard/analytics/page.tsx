    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        {[
          ...
          <div key={s.label} className="card-lift-subtle rounded-xl border border-white/20 bg-[#0D0D0D] p-4">
...
function BreakdownCard({
  ...
  return (
    <div className="card-lift-subtle rounded-xl border border-white/20 bg-[#0D0D0D] p-4">
